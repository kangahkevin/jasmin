...
class SmppsCredentialTestCase(TestCase):
    def test_normal_noargs(self):
        ...
        self.assertEqual(sc.getAuthorization('ip'), '0.0.0.0/0,::/0')
    ...
    def test_ip_authorization_invalid(self):
        ...
        # empty string disallowed (use 0.0.0.0/0,::/0 explicitly)
    ...
    def test_ip_authorization_backcompat(self):
        ...
        self.assertEqual(sc2.getAuthorization('ip'), '0.0.0.0/0,::/0')
