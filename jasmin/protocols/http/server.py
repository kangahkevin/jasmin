...
class HTTPApi(Resource):
    ...
    def __init__(self, RouterPB, SMPPClientManagerPB, config, interceptor=None, smpps_id='smpps_01'):
        ...
        self.putChild(b'metrics', Metrics(SMPPClientManagerPB, log, smpps_id))
