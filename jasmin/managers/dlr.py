...
class DLRLookup:
    ...
    def __init__(self, config, amqpBroker, redisClient):
        ...
        self.requeue_timers = {}
        self.stats = DLRLookupStatsCollector().get()
        ...
        try:
            ...
            if dlr['sc'] == 'httpapi':
                ...
                if dlr_level in [1, 3]:
                    ...
                    yield self.amqpBroker.publish(exchange='messaging',
                                                  ...
                                                  content=DLRContentForHttpapi(dlr_status,
                                                                               ...
                                                                               method=dlr_method))
                    self.stats.inc('publish_http_count')
                    ...
                    if dlr_level == 1 or dlr_status != 'ESME_ROK':
                        ...
                        self.stats.inc('map_removed_count')
                else:
                    self.log.debug(
                ...
                if dlr_level in [2, 3] and dlr_status == 'ESME_ROK':
                    ...
                    self.stats.inc('map_created_count')
                ...
                smpps_map_expiry = int(dlr['expiry'])
                    ...
                    if (dlr_status != 'ESME_ROK' or (dlr_status == 'ESME_ROK' and
                        ...
                        yield self.amqpBroker.publish(exchange='messaging',
                                                      ...
                                                      content=DLRContentForSmpps(dlr_status, msgid, system_id,
                                                                                 ...
                                                                                 dest_addr_ton,
                                                                                 dest_addr_npi))
                        self.stats.inc('publish_smpps_count')
            ...
            self.stats.inc('lookup_error_count')
