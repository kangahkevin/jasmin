...
class RouterPBConfig(ConfigFile):
    ...
    def __init__(self, config_file=None):
        ...
        self.store_backend = self._get('router', 'store_backend', 'file')
        self.store_redis_prefix = self._get('router', 'store_redis_prefix', 'jasmin:')
        self.store_file_backup = self._getbool('router', 'store_file_backup', True)
