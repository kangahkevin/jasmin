...
| [`misc/scripts/sms_logger_pgsql.py`](./sms_logger_pgsql.py) | Sibling helper — logs sent SMS to PostgreSQL |
| [`misc/scripts/sms_logger_mysql.py`](./sms_logger_mysql.py) | Sibling helper — logs sent SMS to MySQL/MariaDB |
